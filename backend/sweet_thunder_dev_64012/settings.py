"""
Django settings for sweet_thunder_dev_64012 project.
...
ROOT_URLCONF = 'sweet_thunder_dev_64012.urls'
...
WSGI_APPLICATION = 'sweet_thunder_dev_64012.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_thunder_dev_64012 API",
    "DESCRIPTION": "API documentation for sweet_thunder_dev_64012 App",
    "VERSION": "v1",
}
